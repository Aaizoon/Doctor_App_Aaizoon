...
import 'package:aazioondoctorapp/incomehistory/bloc/getOnlineEarnings.dart';
...
class _OnlineIncomeState extends State<OnlineIncome> {
  GetOnlineEarningsBloc _getOnlineEarningsBloc;
  bool tap=false;
  var pData=[];
  String month="";
  String year="";
  String totalEarning="";
  GetIncomeOnlineResponseModel apiModel;
  ...
  void initState() {
    super.initState();
    _getOnlineEarningsBloc=GetOnlineEarningsBloc();
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
          ...
          children: [
            ...
            Padding(
              ...
              child: RaisedButton(onPressed:() async {
                ...
                _getOnlineEarningsBloc.getOnlineEarnings(body);
              }, child: Text("Get Details",style: TextStyle(color: Colors.black),),
                color: Colors.white,),
            )
          ],
        ),
        StreamBuilder<ApiResponse<GetIncomeOnlineResponseModel>>(
            stream: _getOnlineEarningsBloc.getStream,
        ...
        //                 children: [
        //                   // Text(
        //                   //   apiModel.data.appointmentList.data[index].,
        //                   //   style: TextStyle(color: Colors.black, fontSize: 17, fontWeight: FontWeight.w400),
        //                   // ),
        //                   Padding(padding: EdgeInsets.fromLTRB(0, 5, 0, 0)),
        //                   Text(
        //                     apiModel.data.appointmentList.data[index].apptmtDate.toString(),
        //
        ...
        //                     children: [
        //                       Text(
        //                         apiModel.data.appointmentList.data[index].subtotal,
        //                         style: TextStyle(color: Colors.grey, fontSize: 15, fontWeight: FontWeight.w300),
        //                       ),
        //                     ],
        //                   )
        ...
        tap==true?Container(
            ...
            child:Text(" Your Earnings(Online): $totalEarning  ",style: TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.bold))
        ):Container(),
        tap==true?ListView.builder(
          scrollDirection: Axis.vertical,
          itemCount: apiModel.data.appointmentList.data.length,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            apiModel.data.appointmentList.data[index].name,
                            style: TextStyle(color: Colors.black, fontSize: 17, fontWeight: FontWeight.w400),
                          ),
                          Padding(padding: EdgeInsets.fromLTRB(0, 5, 0, 0)),
                          Text(
                          ...
                          Padding(padding: EdgeInsets.fromLTRB(0, 5, 0, 0)),
                          Text(
                            apiModel.data.appointmentList.data[index].mobileNumber,
                            style: TextStyle(color: Colors.black, fontSize: 15, fontWeight: FontWeight.w300),
                          ),
                          Padding(padding: EdgeInsets.fromLTRB(0, 5, 0, 0)),
                          Row(
