...
class doctornotewriting extends StatefulWidget {
  @override
  _ExamplePageState createState() => new _ExamplePageState();
}

class _ExamplePageState extends State<doctornotewriting> {
  bool _finished;
  ...
  PainterController newController() {
    ...
    controller.backgroundColor = Colors.cyanAccent;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(height: MediaQuery.of(context).size.height, child: Painter(_controller)),
    );
  }
}
